...
CarDetailsResponseModel carDetailsReponseModelFromJson(String str) =>
    CarDetailsResponseModel.fromJson(json.decode(str));
...
class CarDetailsResponseModel {
  ...
  factory CarDetailsResponseModel.fromJson(Map<String, dynamic> json) =>
      CarDetailsResponseModel(
        remark: json["remark"],
        status: json["status"],
        message:
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        roomTypeImageUrl: json["room_type_image_url"] != null
            ? json["room_type_image_url"].toString()
            : '',
        facilities: json["facilities"] == null
            ? []
            : List<Ity>.from(json["facilities"].map((x) => Ity.fromJson(x))),
        amenities: json["amenities"] == null
            ? []
            : List<Ity>.from(json["amenities"].map((x) => Ity.fromJson(x))),
        totalFacilities: json["total_facilities"] != null
            ? json["total_facilities"].toString()
            : '',
...
class Pivot {
  ...
  factory Pivot.fromJson(Map<String, dynamic> json) => Pivot(
        roomTypeId:
            json["room_type_id"] != null ? json["room_type_id"].toString() : '',
        amenitiesId:
            json["amenities_id"] != null ? json["amenities_id"].toString() : '',
        createdAt:
            json["created_at"] != null ? json["created_at"].toString() : '',
        updatedAt:
            json["updated_at"] != null ? json["updated_at"].toString() : '',
        complementId: json["complement_id"] != null
            ? json["complement_id"].toString()
            : '',
        facilityId:
            json["facility_id"] != null ? json["facility_id"].toString() : '',
      );
}
...
class Car {
  ...
  factory Car.fromJson(Map<String, dynamic> json) => Car(
        ...
        isFeatured:
            json["is_featured"] != null ? json["is_featured"].toString() : '',
        status: json["status"] != null ? json["status"].toString() : '',
        verCodeSendAt: json["ver_code_send_at"] != null
            ? json["ver_code_send_at"].toString()
            : '',
        banReason:
            json["ban_reason"] != null ? json["ban_reason"].toString() : '',
        avgRating:
            json["avg_rating"] != null ? json["avg_rating"].toString() : '',
        minFare:
            json["minimum_fare"] != null ? json["minimum_fare"].toString() : '',
        expireAt: DateTime.parse(json["expire_at"]),
        createdAt: json["created_at"],
        updatedAt: json["updated_at"],
        carSetting: json["car_setting"] == null
            ? null
            : CarSetting.fromJson(json["car_setting"]),
        roomTypes: json["room_types"] == null
            ? []
            : List<RoomType>.from(
                json["room_types"].map((x) => RoomType.fromJson(x))),
        coverPhotos: json["cover_photos"] == null
            ? []
            : List<CoverPhoto>.from(
                json["cover_photos"].map((x) => CoverPhoto.fromJson(x))),
      );
}
...
class CoverPhoto {
  ...
  factory CoverPhoto.fromJson(Map<String, dynamic> json) => CoverPhoto(
        ...
        ownerId: json["owner_id"] != null ? json["owner_id"].toString() : '',
        coverPhoto:
            json["cover_photo"] != null ? json["cover_photo"].toString() : '',
        createdAt: json["created_at"],
        updatedAt: json["updated_at"],
...
class CarSetting {
  ...
  factory CarSetting.fromJson(Map<String, dynamic> json) => CarSetting(
        id: json["id"],
        ownerId: json["owner_id"] != null ? json["owner_id"].toString() : '',
        name: json["name"] != null ? json["name"].toString() : '',
        starRating:
            json["star_rating"] != null ? json["star_rating"].toString() : '',
        logo: json["logo"] != null
            ? json["logo"].toString()
            : MyImages.defaultImageNetwork,
        ...
        address: json["hotel_address"] != null
            ? json["hotel_address"].toString()
            : '',
        ...
        checkoutTime: json["checkout_time"] != null
            ...
            : '00:00:00',
        upcomingCheckinDays: json["upcoming_checkin_days"] != null
            ? json["upcoming_checkin_days"].toString()
            : '',
        upcomingCheckoutDays: json["upcoming_checkout_days"] != null
            ? json["upcoming_checkout_days"].toString()
            : '',
        description:
            json["description"] != null ? json["description"].toString() : '',
        cancellationPolicy: json["cancellation_policy"] != null
            ? json["cancellation_policy"].toString()
            : '',
        keywords: json["keywords"] != null
            ? List<String>.from(json["keywords"].map((x) => x))
            : null,
        hasHotDeal:
            json["has_hot_deal"] != null ? json["has_hot_deal"].toString() : '',
        createdAt: json["created_at"],
        updatedAt: json["updated_at"],
        ImageUrl: json["image_url"] != null ? json["image_url"].toString() : '',
      );
...
class RoomType {
  ...
  factory RoomType.fromJson(Map<String, dynamic> json) => RoomType(
        ...
        name: json["name"] != null ? json["name"].toString() : '',
        totalAdult:
            json["total_adult"] != null ? json["total_adult"].toString() : '',
        totalChild:
            json["total_child"] != null ? json["total_child"].toString() : '',
        ...
        description:
            json["description"] != null ? json["description"].toString() : '',
        beds: json["keywords"] != null
            ? List<String>.from(json["beds"].map((x) => x))
            : null,
        cancellationFee: json["cancellation_fee"] != null
            ? json["cancellation_fee"].toString()
            : '',
        cancellationPolicy: json["cancellation_policy"] != null
            ? json["cancellation_policy"].toString()
            : '',
        featureStatus: json["feature_status"] != null
            ? json["feature_status"].toString()
            : '',
        status: json["status"] != null ? json["status"].toString() : '',
        createdAt: json["created_at"],
        updatedAt: json["updated_at"],
        totalRooms:
            json["total_rooms"] != null ? json["total_rooms"].toString() : '',
        bookedRooms:
            json["booked_rooms"] != null ? json["booked_rooms"].toString() : '',
        availableRooms: json["available_rooms"] != null
            ? json["available_rooms"].toString()
            : '',
        totalCapacity: json["total_capacity"] != null
            ? json["total_capacity"].toString()
            : '',
        isFeatured:
            json["is_featured"] != null ? json["is_featured"].toString() : '',
        image: json["image"] != null ? json["image"].toString() : '',
        discountedFare: json["discounted_fare"] != null
            ? json["discounted_fare"].toString()
            : '',
