...
FeaturedCarResponseModel featuredCarResponseModelFromJson(String str) =>
    FeaturedCarResponseModel.fromJson(json.decode(str));

class FeaturedCarResponseModel {
  String? remark;
  String? status;
  Message? message;
  Data? data;

  FeaturedCarResponseModel({
    this.remark,
    this.status,
    this.message,
    this.data,
  ...
  factory FeaturedCarResponseModel.fromJson(Map<String, dynamic> json) =>
      FeaturedCarResponseModel(
        remark: json["remark"],
        status: json["status"],
        message:
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        featuredCars: json["featured_cars"] == null
            ? null
            : FeaturedCars.fromJson(json["featured_cars"]),
      );
}
...
class FeaturedCars {
  ...
  factory FeaturedCars.fromJson(Map<String, dynamic> json) => FeaturedCars(
        currentPage:
            json["current_page"] != null ? json["current_page"].toString() : '',
        data: json["data"] != null
