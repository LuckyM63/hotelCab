...
PopularCarResponseModel popularCarResponseModelFromJson(String str) =>
    PopularCarResponseModel.fromJson(json.decode(str));

class PopularCarResponseModel {
  String? remark;
  String? status;
  Message? message;
  Data? data;

  PopularCarResponseModel({
    this.remark,
    this.status,
    this.message,
    this.data,
  ...
  factory PopularCarResponseModel.fromJson(Map<String, dynamic> json) =>
      PopularCarResponseModel(
        remark: json["remark"],
        status: json["status"],
        message:
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        countryCode:
            json["country_code"] != null ? json["parent_id"].toString() : '',
