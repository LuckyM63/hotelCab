...
class _CalendarRangePickerDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String endDateText = _formatRangeEndDate(localizations, selectedStartDate, selectedEndDate, DateTime.now());
    final int startWeekDayNumber = daysName(selectedStartDate);
    final int endWeekDayNumber = daysName(selectedEndDate);
    final String endDaysName = _formatRangeEndDate(localizations, selectedEndDate, selectedEndDate, DateTime.now());
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            icon: const Icon(Icons.arrow_back_ios,size: 18,color: MyColor.titleColor),
          ),
          title: const Text(MyStrings.selectDates,style: mediumLarge,),
          actions: <Widget>[
              ...
              Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(MyStrings.checkIn.tr,style: regularLarge,),
                      const SizedBox(height: 5,),
                      Text(Get.find<HomeController>().isClickCheckOut ? Get.find<HomeController>().checkInDate : startDateText,style: boldLarge,)
                    ],
                  ),
                  SvgPicture.asset(MyImages.arrowRight,width: 35,height: 35,colorFilter: const ColorFilter.mode(MyColor.titleColor, BlendMode.srcIn),),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(MyStrings.checkOut.tr,style: regularLarge,),
                      const SizedBox(height: 5,),
                      // Text(Get.find<HomeController>().isClickCheckOut ? startDateText : endDateText,style: boldLarge,)
                      Text(endDateText,style: boldLarge,)
                    ],
                  )
                ],
              ),
              ...
              RoundedButton(
                ...
                press: () {
                  ...
                  if(controller.isClickCheckOut){
                    ...
                    controller.setCheckInCheckOutDate(startDateText, endDateText,startDays,endDays);
                  }
