      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
                  ...
                  children: [
                    Text(
                      ...
                      style: regularSmall.copyWith(
                          color: MyColor.thinTextColor, fontSize: 11),
                    ),
                    Text(
                      controller.searchedPlaceName.tr,
                      style: semiBoldLarge.copyWith(
                          color: MyColor.titleTextColor, fontSize: 15),
                    ),
                    Text(
                      controller.searchedPlaceCountry.tr,
                      style: regularSmall.copyWith(
                          color: MyColor.titleTextColor.withOpacity(.7),
                          fontSize: 13),
                    ),
                  ],
                ),
            ...
            //         Text(
            //           "${controller.numberOfGuests} ${MyStrings.guests.tr}, ${controller.numberOfRooms} ${MyStrings.rooms.tr}",
            //           style: semiBoldLarge.copyWith(
            //               color: MyColor.titleTextColor,
            //               fontSize: 14,
