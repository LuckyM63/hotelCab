      ...
      child: SafeArea(
        child: Column(
          children: [
            ...
            Column(
              children: List.generate(controller.roomList.length, (index) => GestureDetector(
                  onTap: () {
                    controller.changeExpandIndex(index);
                  },
                  child: AddingRoomCard(controller: controller,index: index)),
              ),
            ),
              ...
              children: [
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(MyStrings.addAnotherRoom.tr,style: regularLarge,)
                      ],
                    ),
                  ),
                ),
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Text(MyStrings.done.tr,style: boldLarge.copyWith(color: MyColor.colorWhite),),
                  ),
                )
              ],
            )
