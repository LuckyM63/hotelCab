...
class PopularCitySection extends StatelessWidget {
      ...
      builder: (controller) => Column(
        ...
        children: [
          CustomHeader(
            ...
            isShowSeeMoreButton: controller.popularCityList.length < controller.totalPopularCities,
            actionPress: () {
          ...
          Container(
            ...
            child: GridView.builder(
              ...
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,crossAxisSpacing: 12,mainAxisSpacing: 12,childAspectRatio: .8,mainAxisExtent: size.height * .25),
              ...
              return GestureDetector(
                  onTap: () {
                    if(controller.checkOutDate == MyStrings.checkOutDate || controller.checkOutDate == MyStrings.startDate){
                      ...
                      controller.manageSearchTextForDestinationClick(cityData.name ?? '', cityData.country?.name ?? '', cityData.id.toString());
  ...
  Future<Color> getImageDominantColor(String imagePath) async {
    ...
    Color imageColor = paletteGenerator.dominantColor?.color ?? MyColor.colorWhite;
