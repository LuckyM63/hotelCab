...
import 'package:booking_box/view/screens/car_details_screen/widget/car_facilities_bottom_sheet.dart';
import 'package:booking_box/view/screens/car_details_screen/widget/filter_section_details_screen.dart';
import 'package:booking_box/view/screens/car_details_screen/widget/full_view_map.dart';
...
import '../../../data/repo/car_details/car_details_repo.dart';
...
class CarDetailsScreen extends StatefulWidget {
  ...
  const CarDetailsScreen({Key? key, required this.hotelId}) : super(key: key);
...
class _CarDetailsScreenState extends State<CarDetailsScreen> {
  ...
  void initState() {
    ...
    Get.put(CarDetailsRepo(apiClient: Get.find()));
    final controller =
        Get.put(CarDetailsScreenController(carDetailsRepo: Get.find()));
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<CarDetailsScreenController>(
      builder: (controller) {
                        ...
                        child: Stack(children: [
                          SizedBox(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount:
                                  controller.car?.coverPhotos?.length ?? 1,
                              itemBuilder: (context, index) {
                                return GestureDetector(
                                  onTap: () {
                                    List<String> imageList = [];
                                    controller.car?.coverPhotos
                                        ?.forEach((element) {
                                      imageList
                                ...
                                children: [
                                  ...
                                  MarqueeWidget(
                                    child: Row(
                                      children: [
                                        ...
                                        Text(
                                          "${controller.carSetting?.starRating} ${MyStrings.starHotel.tr}",
                                          style: regularDefault.copyWith(
                                              color: MyColor.titleTextColor),
                                        )
                                      ],
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      CustomReadMoreText(
                                        '${controller.carSetting?.description ?? ''} ',
                                        trimLines: 4,
                                        colorClickableText:
                                            MyColor.primaryColor,
                          ...
                          Positioned(
                            ...
                            child: Center(
                              child: Row(
                                  children: List.generate(
                                      controller.car?.coverPhotos?.length ?? 0,
                                      (index) => Container(
                                            width: 7,
                                            height: 7,
                                            margin:
                ...
                : Container(
                    ...
                    child: RoundedButton(
                        ...
                        textColor: controller.isRoomAvailable
                            ? MyColor.colorWhite
                            : MyColor.colorWhite.withOpacity(.7),
                        press: () {
                          if (controller.carController.checkOutDate ==
