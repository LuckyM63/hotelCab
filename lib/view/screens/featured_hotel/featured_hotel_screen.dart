...
class _FeaturedHotelScreenState extends State<FeaturedHotelScreen> {
  ...
  void initState() {
    ...
    final controller = Get.put(FeaturedHotelController(featuredHotelRepo: Get.find()));
          ...
          body: controller.isLoading ? const CustomLoader() : SafeArea(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                var hotelList = controller.featuredHotelList[index].hotelSetting;
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                width: size.width,
                                fit: BoxFit.cover,
                                imageUrl: hotelList?.imageUrl ?? MyImages.defaultImageNetwork,
                        ...
                        Text(hotelList?.name?.tr ?? '',style: semiBoldLarge),
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(child: Text(hotelList?.hotelAddress?.tr ?? '',style: regularDefault.copyWith(color: MyColor.primaryTextColor),))
                          ],
                        ),
                      ],
                    ),
